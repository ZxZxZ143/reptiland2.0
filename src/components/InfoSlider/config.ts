...
export const sliderMapping: Array<ISliderMapping> = [
    ...
    },
    {
        id: 3,
        title: "Лекции",
        description: "На выставке Reptiland вас ждёт серия лекций от специалистов. Темы охватывают самые разные направления: сохранение экосистем, правила СИТЕС, рептилий и амфибий, других животных, а также основы ответственного содержания питомцев. Это отличная возможность узнать больше у экспертов и задать свои вопросы!",
