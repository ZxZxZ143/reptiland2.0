...
export const schemaSectionMapping: ISchemaSection = {
    "04.10": [
        {
            id: 0,
            title: 'На лекции будут рассмотрены вопросы деятельности фонда Tasbaqa, участия обычных людей в сохранение экосистем и судьбы среднеазиатской черепахи.',
            time: '15:00',
        ...
        {
            id: 2,
            title: 'Лекция “Спайдервёрс Казахстана” - о многолетних исследованиях арахнофауны страны, редких паукообразных и проекте iNaturalist.',
            time: '17:00',
