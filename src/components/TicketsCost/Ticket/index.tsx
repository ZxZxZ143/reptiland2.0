    ...
    return (
        <div className="flex justify-between lg:max-w-[460px] gap-3">
            <div className="flex gap-6">
                <Image src={img} alt={alt} className="min-w-16 md:w-[74px] md:h-[74px] w-16 h-16 aspect-square" />
            ...
            {
                age && (
                    <div className="bg-bg-age rounded-[10px] h-fit w-fit inline-flex justify-center items-center px-5 md:px-3.5 pt-1.5 pb-2">
